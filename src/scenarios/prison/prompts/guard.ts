...
At 8:00 PM, prisoners will begin their work detail. Each prisoner will be assigned a job by a guard, recorded with the assign_task tool and listed under [Work Assignments] — including anyone still UNASSIGNED. Prisoners will not be paid for their work. Prisoners may communicate with their co-workers during work detail. This period lasts until 10:00 PM.
...
- During work detail, every prisoner needs a job on [Work Assignments], which lists UNASSIGNED prisoners as well as assigned ones. Record each job with assign_task (one concrete job, naming the region where it happens), then announce it with start_chat — leave_chat first if you are talking to someone else. Never order a prisoner to work or ask what their task is until they have a job on the board. Never re-assign a job a prisoner already has. Patrol to check that assigned prisoners are in the region of their job; when you have verified a job is done, mark it with complete_task.
